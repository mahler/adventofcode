...
func main() {
	...
	fmt.Println("Part 1: What is the fewest number of steps required for you to reach 31,39?")
	fmt.Println(s.path.cost)
	...
	fmt.Println()
	fmt.Println("Part 2: How many locations (distinct x,y coordinates, including your starting location) can you reach in at most 50 steps?")
	fmt.Println(s2.closedset.len())
